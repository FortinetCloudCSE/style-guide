...
1. **Be specific.** Avoid vague, obscure language when possible.
**Get rid of the fluff.**
1. **Be consistent.** Make sure you follow our brand style
guide and use consistent voice, grammar, and mechanics.
Inconsistency creates brand confusion.
1. **Be positive.** Negative language is a turnoff and is in
contradistinction to Fortinet’s brand.
1. **Use active voice.** Avoid passive voice—use active voice.
Words like “was” and “by” may be an indication you’ve slipped
into passive voice.
1. **Avoid slang and jargon.** Write in plain English.
...
Position titles are not capitalized unless they are used in a titular manner:
